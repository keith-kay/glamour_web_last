              ...
              <div class="content-2">
                <div id="search">
                        <div id="div_print" class="recent-payments">
                            <div class="heading">
                                <h2>Total Bookings Made <?php echo $_GET['month']?></h2>
                                <a href="bookedreports.php" class="del">Back</a></button>
                                </div>
                                         <table>     
                                                        <tr>     
                                                        <th>Booked By</th> 
                                                        ...
                                                        WHERE monthname(glm_db_appointments_date)='".$_GET['month']."' ORDER BY glm_db_appointments_date ASC";
                                                        $result = $db->query($sql);
                                                        if ($result->num_rows > 0) {
                                                        // output data of each row
                                                        while($row = $result->fetch_assoc()) {     
                                                        echo "<tr><td>" . $row["glm_db_users_name"] . "</td><td>" . $row["glm_db_services_name"]. "</td><td>" . $row["glm_db_appointments_date"]. "</td><td>" . $row["glm_db_appointments_time"]. "</td><td>" . $row["glm_db_appointments_serviceprovider"]. "</td></tr><br>";  }
