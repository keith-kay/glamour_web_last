       ...
       <div class="content-2">
              <div class="recent-payments">
                 <div class="heading">
                   ...
                   {
                   echo "<tr><td>" . $row["glm_db_employees_id"] . "</td><td>" . $row["glm_db_employees_name"]. "</td><td>" . $row["glm_db_employees_email"]. "</td><td>" . $row["glm_db_employees_job_description"]. "</td><td> <a href=empdelete.php?id=" .$row["glm_db_employees_id"]. " class=del>Delete</a></td></tr><br>"; }
                   echo "</table>";
                   } else { echo "0 results"; }
