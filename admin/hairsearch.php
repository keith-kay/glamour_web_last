        ...
        <div class="content">
                ...
                <div id="search">
                        <div id="div_print" class="recent-payments">
                            <div class="heading">
                                <h2>Total Bookings Made in <?php echo $_GET['date']; ?> </h2>
                                <a href="haircare.php" class="del">Back</a></button>
                                         ...
                                         <table>
                                                        ...
                                                        WHERE  glm_db_services_name = 'Hair Care'  AND  glm_db_appointments_date = '".$_GET['date']."' ORDER BY glm_db_appointments_date ASC";
                                                        $result = $db->query($sql);
