                ...
                <div id="search">
                        <div id="div_print" class="recent-payments">
                            <div class="heading">
                                ...
                                <a href="haircare.php" class="del">Back</a></button>
                                </div>
                                         <table>     
                                                        <tr>     
                                                        <th>Booked By</th> 
                                                        ...
                                                        WHERE glm_db_services_name = 'Hair Care' AND monthname(glm_db_appointments_date)='".$_GET['month']."' ORDER BY glm_db_appointments_date ASC";
                                                        $result = $db->query($sql);
